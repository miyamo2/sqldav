...
func TestSet_Value_String(t *testing.T) {
	type want struct {
		value *types.AttributeValueMemberSS
		error error
	}
	type test struct {
		sut  Set[string]
	...
	tests := map[string]test{
		"happy-path": {
			sut: Set[string]{"1"},
			want: want{
				value: &types.AttributeValueMemberSS{Value: []string{"1"}},
			},
		},
	}
	opts := []cmp.Option{
...
func TestSet_Value_Int(t *testing.T) {
	type want struct {
		value *types.AttributeValueMemberNS
		error error
	}
	type test struct {
		sut  Set[int]
	...
	tests := map[string]test{
		"happy-path": {
			sut: Set[int]{1},
			want: want{
				value: &types.AttributeValueMemberNS{Value: []string{"1"}},
			},
		},
	}
	opts := []cmp.Option{
...
func TestSet_Value_Float64(t *testing.T) {
	type want struct {
		value *types.AttributeValueMemberNS
		error error
	}
	...
	tests := map[string]test{
		"happy-path": {
			sut: Set[float64]{1.1},
			want: want{
				value: &types.AttributeValueMemberNS{Value: []string{"1.1"}},
			},
		},
	}
	opts := []cmp.Option{
...
func TestSet_Value_Binary(t *testing.T) {
	type want struct {
		value *types.AttributeValueMemberBS
		error error
	}
	type test struct {
		sut  Set[[]byte]
	...
	tests := map[string]test{
		"happy-path": {
			sut: Set[[]byte]{[]byte("A")},
			want: want{
				value: &types.AttributeValueMemberBS{Value: [][]byte{[]byte("A")}},
			},
		},
	}
	opts := []cmp.Option{
